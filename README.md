...
1. Для работы в графическом режиме необходимо запустить файл simple_crypto_gui.py.
2. В запущенном окне присутствует инструкция пользователя и все функции приложения
в виде кнопок.